 ...
 * @since     1.0
 */
class Presentation_RenderPresentation_Node extends BaseNode
{
	...
	public function compile(\Twig_Compiler $compiler)
	{
        ...
        $compiler->raw(' call_user_func_array(array(\Craft\craft()->presentation, "renderPresentation"), ');
